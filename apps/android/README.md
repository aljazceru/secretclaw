## SecretClaw Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_secretclaw-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm secretclaw gateway --port 18789 --verbose
```
