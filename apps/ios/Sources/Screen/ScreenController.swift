...
final class ScreenController {
    ...
    /// Callback invoked when an secretclaw:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = SecretClawKitResources.bundle
...
/// Handles navigation policy to intercept secretclaw:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept secretclaw:// deep links.
        if url.scheme?.lowercased() == "secretclaw" {
