...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: SecretClawLocationMode) async -> CLAuthorizationStatus {
    ...
    func currentLocation(
        params: SecretClawLocationGetParams,
    ...
    private static func accuracyValue(_ accuracy: SecretClawLocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
