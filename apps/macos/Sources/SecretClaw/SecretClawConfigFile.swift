...
enum SecretClawConfigFile {
    private static let logger = Logger(subsystem: "ai.secretclaw", category: "config")
    ...
    static func stateDirURL() -> URL {
        SecretClawPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        SecretClawPaths.workspaceURL
    }
