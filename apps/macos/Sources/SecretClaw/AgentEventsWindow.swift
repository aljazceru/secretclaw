...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: SecretClawProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": SecretClawProtocol.AnyCodable("start"),
                "name": SecretClawProtocol.AnyCodable("bash"),
            ],
            summary: nil)
