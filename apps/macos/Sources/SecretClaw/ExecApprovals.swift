...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.secretclaw", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        SecretClawPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        SecretClawPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
