...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .secretclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? SecretClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? SecretClawPaths.stateDirURL.path
...
extension Notification.Name {
    static let secretclawSelectSettingsTab = Notification.Name("secretclawSelectSettingsTab")
}
