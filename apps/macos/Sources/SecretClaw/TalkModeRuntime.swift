...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.secretclaw", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.secretclaw", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [SecretClawChatMessage] = messages.compactMap { item in
