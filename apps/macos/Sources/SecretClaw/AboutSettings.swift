...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/secretclaw/secretclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/secretclaw/secretclaw")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "SecretClawBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "SecretClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "SecretClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SecretClawGitCommit") as? String) ??
            "unknown"
    }
