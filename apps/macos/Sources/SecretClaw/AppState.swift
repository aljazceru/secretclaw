...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = SecretClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = SecretClawConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = SecretClawConfigFile.loadDict()
            ...
            SecretClawConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/secretclaw"
        state.remoteCliPath = ""
        return state
    }
}
