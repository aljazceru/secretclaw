...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.secretclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other SecretClaw windows, but below the system’s pop-up menus.
