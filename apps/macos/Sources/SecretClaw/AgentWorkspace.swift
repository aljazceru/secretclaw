...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.secretclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return SecretClawConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - SecretClaw Workspace
