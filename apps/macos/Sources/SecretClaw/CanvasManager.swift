...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.secretclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("SecretClaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__secretclaw__/a2ui/").absoluteString + "?platform=macos"
    }
