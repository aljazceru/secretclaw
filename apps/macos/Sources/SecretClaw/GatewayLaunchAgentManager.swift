...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.secretclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".secretclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.secretclawCommand(
            subcommand: "gateway",
