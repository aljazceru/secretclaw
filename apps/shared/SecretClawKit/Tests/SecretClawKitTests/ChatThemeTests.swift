...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = SecretClawChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = SecretClawChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
