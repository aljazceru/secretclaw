...
@MainActor
public struct SecretClawChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: SecretClawChatViewModel
    ...
    public init(
        viewModel: SecretClawChatViewModel,
    ...
    public var body: some View {
        ZStack {
            if self.style == .standard {
                SecretClawChatTheme.background
                    .ignoresSafeArea()
            }
    ...
    private var visibleMessages: [SecretClawChatMessage] {
        let base: [SecretClawChatMessage]
    ...
    private func mergeToolResults(in messages: [SecretClawChatMessage]) -> [SecretClawChatMessage] {
        ...
        for message in messages {
            ...
            let merged = SecretClawChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: SecretClawChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: SecretClawChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: SecretClawChatMessage) -> String {
