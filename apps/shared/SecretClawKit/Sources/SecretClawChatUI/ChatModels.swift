...
public typealias SecretClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias SecretClawPlatformImage = UIImage
#endif

public struct SecretClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct SecretClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: SecretClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(SecretClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct SecretClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct SecretClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [SecretClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: SecretClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [SecretClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: SecretClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(SecretClawChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([SecretClawChatMessageContent].self, forKey: .content) {
...
public struct SecretClawChatHistoryPayload: Codable, Sendable {
...
public struct SecretClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct SecretClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [SecretClawSessionPreviewItem]
}

public struct SecretClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [SecretClawSessionPreviewEntry]

    public init(ts: Int, previews: [SecretClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct SecretClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct SecretClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct SecretClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct SecretClawChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct SecretClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct SecretClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: SecretClawPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: SecretClawPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct SecretClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
