...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.secretclaw", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.secretclaw", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: SecretClawProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
