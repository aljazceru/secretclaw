...
public enum SecretClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct SecretClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct SecretClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
