...
show_usage() {
    cat << EOF
clawlog - SecretClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View SecretClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    SecretClaw logs flow through the macOS unified log (subsystem: ai.secretclaw).
