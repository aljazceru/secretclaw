...
if [[ -z "$version_content" ]]; then
  echo "<h2>SecretClaw $VERSION</h2>"
  echo "<p>Latest SecretClaw update.</p>"
  echo "<p><a href=\"https://github.com/secretclaw/secretclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
