...
# Output:
# - dist/SecretClaw.app
# - dist/SecretClaw-<version>.zip
# - dist/SecretClaw-<version>.dmg
...
APP="$ROOT_DIR/dist/SecretClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/SecretClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/SecretClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/SecretClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/SecretClaw-$VERSION.dSYM.zip"
