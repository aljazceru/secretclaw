...
SecretClaw has two separate “streaming” layers:
...
When block streaming is enabled, SecretClaw can **merge consecutive block chunks**
...
When draft streaming is active, SecretClaw disables block streaming for that reply to avoid double-streaming.
