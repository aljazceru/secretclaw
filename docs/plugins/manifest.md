...
read_when:
  - You are building a SecretClaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (secretclaw.plugin.json)

Every plugin **must** ship a `secretclaw.plugin.json` file in the **plugin root**.
SecretClaw uses this manifest to validate configuration **without executing plugin
