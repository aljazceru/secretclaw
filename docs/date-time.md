...
SecretClaw defaults to **host-local time for transport timestamps** and **user timezone only in the system prompt**.
...
When `timeFormat: "auto"`, SecretClaw inspects the OS preference (macOS/Windows)
