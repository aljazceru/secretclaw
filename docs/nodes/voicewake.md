...
SecretClaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.secretclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["secretclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
