---
summary: "Use Synthetic's Anthropic-compatible API in SecretClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. SecretClaw registers it as the
...
Note: SecretClaw's Anthropic client appends `/v1` to the base URL, so use
