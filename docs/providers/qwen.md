---
summary: "Use Qwen OAuth (free tier) in SecretClaw"
read_when:
  - You want to use Qwen with SecretClaw
...
If you already logged in with the Qwen Code CLI, SecretClaw will sync credentials
