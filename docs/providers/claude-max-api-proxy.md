...
You can point SecretClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or SecretClaw
...
- [Anthropic provider](/providers/anthropic) - Native SecretClaw integration with Claude setup-token or API keys
