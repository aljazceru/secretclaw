---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with SecretClaw"
read_when:
  - You want Xiaomi MiMo models in SecretClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). SecretClaw uses
