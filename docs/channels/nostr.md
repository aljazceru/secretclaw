...
read_when:
  - You want SecretClaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables SecretClaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`secretclaw onboard`) and `secretclaw channels add` list optional channel plugins.
...
```bash
secretclaw plugins install @secretclaw/nostr
```

Use a local checkout (dev workflows):

```bash
secretclaw plugins install --link <path-to-secretclaw>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "secretclaw",
        "displayName": "SecretClaw",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "secretclaw@example.com",
        "lud16": "secretclaw@example.com"
      }
    }
  }
}
