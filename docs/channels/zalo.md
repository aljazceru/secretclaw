...
- Install via CLI: `secretclaw plugins install @secretclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `secretclaw plugins install ./extensions/zalo`
   - From npm (if published): `secretclaw plugins install @secretclaw/zalo`
...
- Approve via:
  - `secretclaw pairing list zalo`
  - `secretclaw pairing approve zalo <CODE>`
...
- Example: `secretclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `secretclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `secretclaw logs --follow`
