...
import type { SecretClawConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: SecretClawConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: SecretClawConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: SecretClawConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: SecretClawConfig) => void;
  log: {
