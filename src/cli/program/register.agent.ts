...
${formatHelpExamples([
  ['secretclaw agent --to +15555550123 --message "status update"', "Start a new session."],
  ['secretclaw agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
    'secretclaw agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'secretclaw agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['secretclaw agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
    'secretclaw agent --agent ops --message "Generate report" --deliver --reply-channel slack --reply-to "#reports"',
...
${formatHelpExamples([
  [
    'secretclaw agents set-identity --agent main --name "SecretClaw" --emoji "🦞"',
    "Set name + emoji.",
  ],
  [
    "secretclaw agents set-identity --agent main --avatar avatars/secretclaw.png",
    "Set avatar path.",
  ],
  [
    "secretclaw agents set-identity --workspace ~/.secretclaw/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "secretclaw agents set-identity --identity-file ~/.secretclaw/workspace/IDENTITY.md --agent main",
