...
${formatHelpExamples([
  ['secretclaw message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'secretclaw message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'secretclaw message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}
