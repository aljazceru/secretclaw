...
import type { SecretClawPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: SecretClawPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: SecretClawPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
