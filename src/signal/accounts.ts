...
export function listSignalAccountIds(cfg: SecretClawConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: SecretClawConfig): string {
...
function mergeSignalAccountConfig(cfg: SecretClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: SecretClawConfig): ResolvedSignalAccount[] {
