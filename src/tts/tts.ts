...
export function resolveTtsConfig(cfg: SecretClawConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.SECRETCLAW_TTS_PREFS?.trim();
  if (envPath) {
...
export function buildTtsSystemPromptHint(cfg: SecretClawConfig): string | undefined {
