...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof SecretClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: SecretClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: SecretClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
