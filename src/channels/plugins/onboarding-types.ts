...
export type PromptAccountIdParams = {
  ...
  label: string;
  currentId?: string;
  listAccountIds: (cfg: SecretClawConfig) => string[];
...
export type ChannelOnboardingDmPolicy = {
  ...
  policyKey: string;
  allowFromKey: string;
  getCurrent: (cfg: SecretClawConfig) => DmPolicy;
  setPolicy: (cfg: SecretClawConfig, policy: DmPolicy) => SecretClawConfig;
...
export type ChannelOnboardingAdapter = {
  ...
  disable?: (cfg: SecretClawConfig) => SecretClawConfig;
};
