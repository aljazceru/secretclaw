...
export type ChannelAgentToolFactory = (params: { cfg?: SecretClawConfig }) => ChannelAgentTool[];
...
export type ChannelMentionAdapter = {
  stripPatterns?: (params: {
    ctx: MsgContext;
    cfg: SecretClawConfig | undefined;
    agentId?: string;
  }) => string[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: SecretClawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: SecretClawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: SecretClawConfig }) => boolean;
  supportsCards?: (params: { cfg: SecretClawConfig }) => boolean;
