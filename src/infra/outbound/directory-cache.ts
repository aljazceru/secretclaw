...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: SecretClawConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: SecretClawConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: SecretClawConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  clear(cfg?: SecretClawConfig): void {
    this.cache.clear();
    if (cfg) {
  ...
  private resetIfConfigChanged(cfg: SecretClawConfig): void {
