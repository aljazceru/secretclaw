...
function resolveAnthropicDefaultAuthMode(cfg: SecretClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: SecretClawConfig): SecretClawConfig {
...
export function applyTalkApiKey(config: SecretClawConfig): SecretClawConfig {
...
export function applyModelDefaults(cfg: SecretClawConfig): SecretClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: SecretClawConfig): SecretClawConfig {
...
export function applyLoggingDefaults(cfg: SecretClawConfig): SecretClawConfig {
...
export function applyContextPruningDefaults(cfg: SecretClawConfig): SecretClawConfig {
...
export function applyCompactionDefaults(cfg: SecretClawConfig): SecretClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
