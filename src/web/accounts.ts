...
function listConfiguredAccountIds(cfg: SecretClawConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: SecretClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: SecretClawConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: SecretClawConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: SecretClawConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: SecretClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: SecretClawConfig): ResolvedWhatsAppAccount[] {
