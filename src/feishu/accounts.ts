...
function mergeFeishuAccountConfig(cfg: SecretClawConfig, accountId: string): FeishuAccountConfig {
...
export function listFeishuAccountIds(cfg: SecretClawConfig): string[] {
...
export function resolveDefaultFeishuAccountId(cfg: SecretClawConfig): string {
