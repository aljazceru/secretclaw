...
function resolveExecConfig(cfg: SecretClawConfig | undefined) {
...
export function createSecretClawCodingTools(options?: {
  ...
  const base = (codingTools as unknown as AnyAgentTool[]).flatMap((tool) => {
    if (tool.name === readTool.name) {
      ...
      return [createSecretClawReadTool(freshReadTool)];
    }
