  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "secretclaw-sbx-test",
        "--label",
        "secretclaw.sandbox=1",
        "--label",
        "secretclaw.sessionKey=main",
        "--label",
        "secretclaw.createdAtMs=1700000000000",
        "--label",
        "secretclaw.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
