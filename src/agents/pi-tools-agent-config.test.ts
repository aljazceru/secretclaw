...
describe("Agent-specific tool filtering", () => {
    ...
    const cfg: SecretClawConfig = {
      ...
      agents: {
        list: [
          {
            id: "restricted",
            workspace: "~/secretclaw-restricted",
            tools: {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createSecretClawCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createSecretClawCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createSecretClawCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createSecretClawCodingTools({
      config: cfg,
    ...
    const bobTools = createSecretClawCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createSecretClawCodingTools({
      config: cfg,
