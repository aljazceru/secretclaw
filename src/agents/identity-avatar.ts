...
function resolveAvatarSource(cfg: SecretClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: SecretClawConfig, agentId: string): AgentAvatarResolution {
