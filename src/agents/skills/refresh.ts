...
function resolveWatchPaths(workspaceDir: string, config?: SecretClawConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: SecretClawConfig }) {
