...
describe("createSecretClawCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createSecretClawCodingTools({
      config,
    ...
    const anthropicTools = createSecretClawCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createSecretClawCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createSecretClawCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
