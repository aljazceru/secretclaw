...
export const DEFAULT_LOG_DIR = "/tmp/secretclaw";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "secretclaw.log"); // legacy single-file path

const LOG_PREFIX = "secretclaw";
...
function resolveSettings(): ResolvedSettings {
  let cfg: SecretClawConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => SecretClawConfig;
      };
