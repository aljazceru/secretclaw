...
export function listBindings(cfg: SecretClawConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: SecretClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: SecretClawConfig) {
