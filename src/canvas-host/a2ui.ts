...
export const A2UI_PATH = "/__secretclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__secretclaw__/canvas";

export const CANVAS_WS_PATH = "/__secretclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.secretclawCanvasA2UIAction.postMessage(...)
  // - Android: window.secretclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["secretclawCanvasA2UIAction"];
  ...
  globalThis.SecretClaw = globalThis.SecretClaw ?? {};
  globalThis.SecretClaw.postMessage = postToNode;
  globalThis.SecretClaw.sendUserAction = sendUserAction;
  globalThis.secretclawPostMessage = postToNode;
  globalThis.secretclawSendUserAction = sendUserAction;
