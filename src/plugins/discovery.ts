...
import {
  ...
  type SecretClawPackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @secretclaw/voice-call -> voice-call).
...
export function discoverSecretClawPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".secretclaw", "extensions")];
