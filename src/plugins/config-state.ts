...
export const normalizePluginsConfig = (
  config?: SecretClawConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: SecretClawConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: SecretClawConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: SecretClawConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
