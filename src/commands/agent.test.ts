...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "secretclaw-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<SecretClawConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<SecretClawConfig["telegram"]>>,
