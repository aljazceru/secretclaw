...
function resolveDefaultAccountId(cfg: SecretClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: SecretClawConfig): boolean {
...
export function summarizeBindings(cfg: SecretClawConfig, bindings: AgentBinding[]): string[] {
