...
function resolveConfiguredModelRaw(cfg: SecretClawConfig): string {
...
function resolveConfiguredModelKeys(cfg: SecretClawConfig): string[] {
...
export function applyPrimaryModel(cfg: SecretClawConfig, model: string): SecretClawConfig {
...
export function applyModelAllowlist(cfg: SecretClawConfig, models: string[]): SecretClawConfig {
  const defaults = cfg.agents?.defaults;
