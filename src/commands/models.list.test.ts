...
const ensureSecretClawModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveSecretClawAgentDir = vi.fn().mockReturnValue("/tmp/secretclaw-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/secretclaw-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureSecretClawModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveSecretClawAgentDir,
}));
