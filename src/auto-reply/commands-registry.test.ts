...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@secretclaw", { botUsername: "secretclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@secretclaw args", {
        botUsername: "secretclaw",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@secretclaw: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "secretclaw" })).toBe(
      "/help@otherbot",
    );
  });
