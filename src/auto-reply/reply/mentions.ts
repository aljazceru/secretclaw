...
function resolveMentionPatterns(cfg: SecretClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: SecretClawConfig | undefined, agentId?: string): RegExp[] {
