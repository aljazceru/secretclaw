import type { LineChannelData, SecretClawPluginApi, ReplyPayload } from "secretclaw/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: SecretClawPluginApi): void {
  api.registerCommand({
    name: "card",
