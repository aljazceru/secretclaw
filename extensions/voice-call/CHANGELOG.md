...
- Version alignment with core SecretClaw release numbers.
...
- First public release of the @secretclaw/voice-call plugin.
...
- CLI: `secretclaw voicecall` commands (call/start/continue/speak/end/status/tail/expose).
