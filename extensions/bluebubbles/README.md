...
This directory contains the **BlueBubbles external channel plugin** for SecretClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `secretclaw/plugin-sdk` helpers.
