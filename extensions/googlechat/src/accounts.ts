...
export function listGoogleChatAccountIds(cfg: SecretClawConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: SecretClawConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: SecretClawConfig): ResolvedGoogleChatAccount[] {
