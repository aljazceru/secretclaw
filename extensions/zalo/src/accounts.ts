import type { SecretClawConfig } from "secretclaw/plugin-sdk";
...
export function listZaloAccountIds(cfg: SecretClawConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: SecretClawConfig): string {
...
function mergeZaloAccountConfig(cfg: SecretClawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: SecretClawConfig): ResolvedZaloAccount[] {
