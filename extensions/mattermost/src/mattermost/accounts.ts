...
export function listMattermostAccountIds(cfg: SecretClawConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: SecretClawConfig): string {
...
export function listEnabledMattermostAccounts(cfg: SecretClawConfig): ResolvedMattermostAccount[] {
