...
Nostr DM channel plugin for SecretClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to SecretClaw. It enables your bot to:
...
# Configure secretclaw to use local relay
