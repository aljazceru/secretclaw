...
metadata: {"clawdbot":{"emoji":"🍌","requires":{"bins":["uv"],"env":["GEMINI_API_KEY"]},"primaryEnv":"GEMINI_API_KEY","install":[{"id":"uv-system","kind":"system","package":"uv","bins":["uv"],"label":"Install uv via system package manager"}]}}
---
